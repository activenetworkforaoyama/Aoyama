				...
				<c:if test="${authority == '01' || authority == '02' || authority == '05'}">
					<div class="row">
						...
						<div class="col-12 col-md-8">
							<label class=" form-control-label-value">${order.custNm}&#40${order.custKanaNm}&#41</label>様
						</div>
					</div>
				</c:if>
				<div class="row">
				...
				<div class="col col-lg-6">
					...
					<c:if test="${authority == '01' || authority == '02' || authority == '05'}">
						...
						<div class="row">
							...
							<div class="col-12 col-md-9">
								<strong><label class=" form-control-label-value">${order.custNm}</label></strong>
							</div>
						</div>
						<div class="row">
							<div class="col col-md-3">
							...
							<div class="col-12 col-md-9">
								<strong><label class=" form-control-label-value">${order.custKanaNm}</label></strong>
							</div>
						</div>
						<div class="row">
							<div class="col col-md-3">
				...
				<c:if test="${authority == '01' || authority == '02' || authority == '05'}">
					<div class="col col-lg-6">
						...
						<div class="row">
							...
							<div class="col-12 col-md-9">
								<strong><label class=" form-control-label-value">${order.custStaff}</label></strong>
							</div>
						</div>
						<div class="row">
							<div class="col col-md-3">
			...
			<div class="row">
				<div class="col col-lg-12">
					...
					<div class="row">
						...
						<div class="col-12 col-md-9">
							<strong><label class=" form-control-label-value">${order.productFabricNo}-${color}${pattern}</label></strong>
						</div>
					</div>
					<div class="row">
						<div class="col col-md-3">
					...
					<c:if test="${order.productItem == '01' || order.productItem == '02'}">
					<div class="row">
						<div class="col col-md-3">
							<label class=" form-control-label">組成表示　胴裏地</label>
						</div>
						<div class="col-12 col-md-9">
							<strong><label class=" form-control-label-value">${order.productComposBodyLiner}</label></strong>
						</div>
					</div>
					<div class="row">
						<div class="col col-md-3">
...
jQuery("#ChangeStatus").click(function(){
	...
	window.location.href= contextPath + "/orderDetail/changeStatus/" + orderId + "/" + changeTscStatus;
})
...
jQuery("#saveValue").click(function(){
	...
	swal({
		  ...
		  if (isConfirm) {
			...
			window.location.href= contextPath + "/orderDetail/saveValue/?orderId=" + orderId + "&fabricNo=" + fabricNo + "&fabricUsedMount=" + fabricUsedMount + "&shippingDate=" + shippingDate + "&loadingDate=" + loadingDate;
			  }
		})
})
	...
	swal({
		  ...
		  if (isConfirm) {
			//注文ID
				...
				window.location.href= contextPath + "/orderDetail/saveOrChangeValue/" + orderId + "/" + fabricNo + "/" + fabricUsedMount + "/" + shippingDate + "/" + loadingDate + "/" + makerFactoryStatus;
			  }
		})
})
...
jQuery("#nextGenerationSave").on('click', function(){
	...
	if(isNumeric(nextGenerationInputValue)){
		appendAlert('errormssage', getMsgByTwoArgs('msg012', '下代価格','半角数字'));
		return false;
		}
	else if(nextGenerationInputValue > 2147483647){
	...
	window.location.href= contextPath + "/orderDetail/nextGenerationPrice/" + orderId + "/" + nextGenerationPrice;
