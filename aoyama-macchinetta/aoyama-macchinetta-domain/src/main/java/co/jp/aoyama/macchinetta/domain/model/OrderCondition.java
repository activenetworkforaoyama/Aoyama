...
public class OrderCondition implements Serializable {
    ...
    private Date productOrderDnpDateFromDate;
    
    private String productOrderDnpDateTo;
    
    private Date productOrderDnpDateToDate;
	...
	public Date getProductOrderDnpDateFromDate() {
		return productOrderDnpDateFromDate;
	}

	public void setProductOrderDnpDateFromDate(Date productOrderDnpDateFromDate) {
		this.productOrderDnpDateFromDate = productOrderDnpDateFromDate;
	}

	public Date getProductOrderDnpDateToDate() {
		return productOrderDnpDateToDate;
	}

	public void setProductOrderDnpDateToDate(Date productOrderDnpDateToDate) {
		this.productOrderDnpDateToDate = productOrderDnpDateToDate;
	}
