 ...
 */
@Component
public class NonMemberUpdateRealRenkeiTest {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(NonMemberUpdateRealRenkeiTest.class);
    ...
    public NonMemberUpdateResBean requestNonMemberUpdate(NonMemberUpdateReqBean reqBean) throws Exception {
        ...
        UserInfoServiceStubTest.SetNonMemberDataRequest snmRequest = null;

        long kokNo = reqBean.getKokNo();

        try {
            // リクエストクラスの生成
            snmRequest = new UserInfoServiceStubTest.SetNonMemberDataRequest();
            ...
            // 送信用XML
            UserInfoServiceStubTest.SetNonMemberData snm = new UserInfoServiceStubTest.SetNonMemberData();
            ...
            // 顧客サーバへ接続
            UserInfoServiceStubTest.SetNonMemberDataResponseE nonMemberData = stub.setNonMemberData(snm);
            ...
            // XMLの受信
            UserInfoServiceStubTest.SetNonMemberDataResponse nonMemberDataResponse = nonMemberData.getSetNonMemberDataReturn();
     ...
     * @param nonMemberDataResponse 非会員情報更新レスポンス
     * @return 非会員情報更新レスポンスBean
     * @throws Exception
     */
    private NonMemberUpdateResBean makeSetNonMemberDataResBean(UserInfoServiceStubTest.SetNonMemberDataResponse nonMemberDataResponse, UserInfoServiceStubTest.SetNonMemberDataRequest snmRequest) throws Exception {

        // 非会員情報更新レスポンスをBeanにセット
     ...
     * @param snmRequest 非会員情報更新リクエスト
     */

    private void outputReqConfValue(UserInfoServiceStubTest.SetNonMemberDataRequest smiRequest) {
     ...
     */
     private void outputStructReqKokValue(UserInfoServiceStubTest.SetNonMemberDataRequest request) {
