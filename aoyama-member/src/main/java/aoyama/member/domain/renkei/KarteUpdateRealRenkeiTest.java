 ...
 */
@Component
public class KarteUpdateRealRenkeiTest {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(KarteUpdateRealRenkeiTest.class);
    ...
    public KarteUpdateResBean requestKarteUpdate(KarteUpdateReqBean reqBean) throws Exception {
        ...
        UserInfoServiceStubTest.SetMeasureringInfoRequest smiRequest = null;
        long kokNo = reqBean.getKokNo();

        try {
            // リクエストクラスの生成
            smiRequest = new UserInfoServiceStubTest.SetMeasureringInfoRequest();
            ...
            // 送信用XML
            UserInfoServiceStubTest.SetMeasureringInfo smi = new UserInfoServiceStubTest.SetMeasureringInfo();
            ...
            // 顧客サーバへ接続
            UserInfoServiceStubTest.SetMeasureringInfoResponseE measureringInfo = stub.setMeasureringInfo(smi);
            ...
            // XMLの受信
            UserInfoServiceStubTest.SetMeasureringInfoResponse measureringInfoResponse = measureringInfo.getSetMeasureringInfoReturn();
     ...
     * @throws Exception
     */
    private KarteUpdateResBean makeSetMeasureringInfoResBean(UserInfoServiceStubTest.SetMeasureringInfoResponse measureringInfoResponse, UserInfoServiceStubTest.SetMeasureringInfoRequest smiRequest) throws Exception {
    ...
    private void outputReqConfValue(UserInfoServiceStubTest.SetMeasureringInfoRequest smiRequest) {
     ...
     */
     private void outputStructReqKokValue(UserInfoServiceStubTest.SetMeasureringInfoRequest request) {
