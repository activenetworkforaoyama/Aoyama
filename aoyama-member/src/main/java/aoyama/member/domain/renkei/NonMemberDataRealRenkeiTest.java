 ...
 */
@Component
public class NonMemberDataRealRenkeiTest  {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(NonMemberDataRealRenkeiTest.class);
    ...
    public NonMemberDataResBean requestGetNonMemberData(NonMemberDataReqBean reqBean) throws Exception {
        ...
        UserInfoServiceStubTest.GetNonMemberDataRequest gupaRequest = null;
        ...
        String telNo = reqBean.getTelNo();  // 電話番号
    	String sei = reqBean.getSei();  // 姓（カナ）
    	String mei = reqBean.getMei();  // 名（カナ）
        int gyotai = reqBean.getGyotai();  // 業態

        try {
            // リクエストクラスの生成
            gupaRequest = new UserInfoServiceStubTest.GetNonMemberDataRequest();
...
//            gupaRequest.setGyotaiCd(myProp.getRealRenkeiReqGyotaiCd());  // 業態
            ...
            // 送信用XML
            UserInfoServiceStubTest.GetNonMemberData gupa = new UserInfoServiceStubTest.GetNonMemberData();
            ...
            // 顧客サーバへ接続
            UserInfoServiceStubTest.GetNonMemberDataResponseE nonMemberData = stub.getNonMemberData(gupa);
            ...
            // XMLの受信
            UserInfoServiceStubTest.GetNonMemberDataResponse nonMemberDataResponse = nonMemberData.getGetNonMemberDataReturn();
     ...
     */
    private void outputReqConfValue(UserInfoServiceStubTest.GetNonMemberDataRequest gupaRequest) {
     ...
     * @param gupaRequest 非会員情報取得リクエスト
     */
    private void outputReqKokValue(UserInfoServiceStubTest.GetNonMemberDataRequest gupaRequest) {
     ...
     * @throws Exception
     */
    private NonMemberDataResBean makeNonMemberDataResBean(UserInfoServiceStubTest.GetNonMemberDataResponse nonMemberDataResponse, int gyotai) throws Exception {
        // 非会員情報取得レスポンス
        ...
        UserInfoServiceStubTest.ArrayOfStructGetNonMemberDataResponse  array = nonMemberDataResponse.getUserArray();
        UserInfoServiceStubTest.StructGetNonMemberDataResponse[] struct = array.getItem();
