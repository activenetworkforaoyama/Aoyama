 ...
 */
@Component
public class MeasureringInfoRealRenkei {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(MeasureringInfoRealRenkei.class);
    ...
    public MeasureringInfoResBean requestGetMeasureringInfo(MeasureringInfoReqBean reqBean, int gyotaiCd) throws Exception {
        ...
        UserInfoServiceStub.GetMeasureringInfoRequest gmiRequest = null;
        long kokNo = 0;
        try {
            // リクエストクラスの生成
            gmiRequest = new UserInfoServiceStub.GetMeasureringInfoRequest();
            // リクエストに値をセット
            ...
            // 送信用XML
            UserInfoServiceStub.GetMeasureringInfo gmi = new UserInfoServiceStub.GetMeasureringInfo();
            ...
            // 顧客サーバへ接続
            UserInfoServiceStub.GetMeasureringInfoResponseE measureringInfo = stub.getMeasureringInfo(gmi);
         ...
         // 経過時間(終了)
            ...
            // XMLの受信
            UserInfoServiceStub.GetMeasureringInfoResponse measureringInfoResponse = measureringInfo.getGetMeasureringInfoReturn();
     ...
     */
    private MeasureringInfoResBean makeMeasureringInfoResBean(UserInfoServiceStub.GetMeasureringInfoResponse measureringResponse) throws Exception {
     ...
     */
    private void outputReqConfValue(UserInfoServiceStub.GetMeasureringInfoRequest gmiRequest) {
