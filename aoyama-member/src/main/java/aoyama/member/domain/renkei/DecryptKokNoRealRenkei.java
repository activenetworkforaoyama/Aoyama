 ...
 */
@Component
public class DecryptKokNoRealRenkei {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(DecryptKokNoRealRenkei.class);
    ...
    public DecryptKokNoResBean requestGetDecryptKokNo(DecryptKokNoReqBean reqBean, int gyotaiCd) throws Exception {
        ...
        UserInfoServiceStub.GetDecryptKokNoRequest gdknRequest = null;
        try {
            // リクエストクラスの生成
            gdknRequest = new UserInfoServiceStub.GetDecryptKokNoRequest();
            // リクエストに値をセット
         ...
         // 顧客情報配列に顧客番号を設定
            UserInfoServiceStub.StructGetDecryptKokNoRequest[] struct = new UserInfoServiceStub.StructGetDecryptKokNoRequest[dataCnt];
            UserInfoServiceStub.StructGetDecryptKokNoRequest structItem = null;
            for (int i = 0; i < dataCnt; i++) {
                // 顧客No.を設定
                structItem = new UserInfoServiceStub.StructGetDecryptKokNoRequest();
                structItem.setKokNo(reqBean.getDecryptKokNoRequest().get(i).getKokNo());
                struct[i] = structItem;
            }
            UserInfoServiceStub.ArrayOfStructGetDecryptKokNoRequest arrayKokNo = new UserInfoServiceStub.ArrayOfStructGetDecryptKokNoRequest();
            ...
            // 送信用XML
            UserInfoServiceStub.GetDecryptKokNo gdkn = new UserInfoServiceStub.GetDecryptKokNo();
            ...
            // 顧客サーバへ接続
            UserInfoServiceStub.GetDecryptKokNoResponseE decryptKokNo = stub.getDecryptKokNo(gdkn);
            ...
            // XMLの受信
            UserInfoServiceStub.GetDecryptKokNoResponse decryptKokNoResponse = decryptKokNo.getGetDecryptKokNoReturn();
     ...
     * @throws Exception
     */
    private DecryptKokNoResBean makeGetDecryptKokNoResponseBean(UserInfoServiceStub.GetDecryptKokNoResponse response) throws Exception {
        ...
        UserInfoServiceStub.ArrayOfStructGetDecryptKokNoResponse array = response.getUserArray();
        UserInfoServiceStub.StructGetDecryptKokNoResponse[] struct = array.getItem();
