 ...
 */
@Component
public class UserDataRealRenkei  {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(UserDataRealRenkei.class);
    ...
    public UserDataResBean requestGetUserPointArray(UserDataReqBean reqBean, int gyotaiCd) throws Exception {
        ...
        UserInfoServiceStub.GetUserPointArrayRequest gupaRequest = null;
        long kokNo = reqBean.getKokNo();  // 13桁の会員番号

        try {
            // リクエストクラスの生成
            gupaRequest = new UserInfoServiceStub.GetUserPointArrayRequest();
...
//            gupaRequest.setGyotaiCd(myProp.getRealRenkeiReqGyotaiCd());  // 業態
            ...
            // 送信用XML
            UserInfoServiceStub.GetUserPointArray gupa = new UserInfoServiceStub.GetUserPointArray();
            ...
            // 顧客サーバへ接続
            UserInfoServiceStub.GetUserPointArrayResponseE userData = stub.getUserPointArray(gupa);
            ...
            // XMLの受信
            UserInfoServiceStub.GetUserPointArrayResponse userDataResponse = userData.getGetUserPointArrayReturn();
     ...
     */
    private void outputReqConfValue(UserInfoServiceStub.GetUserPointArrayRequest gupaRequest) {
     ...
     * @param gupaRequest 顧客情報取得リクエスト
     */
    private void outputReqKokValue(UserInfoServiceStub.GetUserPointArrayRequest gupaRequest) {
     ...
     * @throws Exception
     */
    private UserDataResBean makeUserDataResBean(UserInfoServiceStub.GetUserPointArrayResponse userDataResponse) throws Exception {
        // 顧客情報取得レスポンス
        UserDataResBean bean = new UserDataResBean();
        
        UserInfoServiceStub.ArrayOfStructGetUserPointArrayResponse  array = userDataResponse.getUserArray();
        UserInfoServiceStub.StructGetUserPointArrayResponse[] struct = array.getItem();
