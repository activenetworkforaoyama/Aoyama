 ...
 */
@Component
public class EncryptKokNoRealRenkeiTest {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(EncryptKokNoRealRenkeiTest.class);
    ...
    public EncryptKokNoResBean requestGetEncryptKokNo(EncryptKokNoReqBean reqBean, int gyotaiCd) throws Exception {
        ...
        UserInfoServiceStubTest.GetEncryptKokNoRequest geknRequest = null;
        try {
            // リクエストクラスの生成
            geknRequest = new UserInfoServiceStubTest.GetEncryptKokNoRequest();
            // リクエストに値をセット
...
//            geknRequest.setGyotaiCd(myProp.getRealRenkeiReqGyotaiCd()); // 業態
         ...
         // 顧客情報配列に顧客番号を設定
            UserInfoServiceStubTest.StructGetEncryptKokNoRequest[] struct = new UserInfoServiceStubTest.StructGetEncryptKokNoRequest[dataCnt];
            UserInfoServiceStubTest.StructGetEncryptKokNoRequest structItem = null;
            for (int i = 0; i < dataCnt; i++) {
                // 顧客No.を設定
                structItem = new UserInfoServiceStubTest.StructGetEncryptKokNoRequest();
                structItem.setKokNo(reqBean.getEncryptKokNoRequest().get(i).getKokNo());
                struct[i] = structItem;
            }
            UserInfoServiceStubTest.ArrayOfStructGetEncryptKokNoRequest arrayKokNo = new UserInfoServiceStubTest.ArrayOfStructGetEncryptKokNoRequest();
            ...
            // 送信用XML
            UserInfoServiceStubTest.GetEncryptKokNo gekn = new UserInfoServiceStubTest.GetEncryptKokNo();
            ...
            // 顧客サーバへ接続
            UserInfoServiceStubTest.GetEncryptKokNoResponseE encryptKokNo = stub.getEncryptKokNo(gekn);
            ...
            // XMLの受信
            UserInfoServiceStubTest.GetEncryptKokNoResponse encryptKokNoResponse = encryptKokNo.getGetEncryptKokNoReturn();
     ...
     * @throws Exception
     */
    private EncryptKokNoResBean makeGetEncryptKokNoResponseBean(UserInfoServiceStubTest.GetEncryptKokNoResponse response) throws Exception {
        ...
        UserInfoServiceStubTest.ArrayOfStructGetEncryptKokNoResponse array = response.getUserArray();
        UserInfoServiceStubTest.StructGetEncryptKokNoResponse[] struct = array.getItem();
