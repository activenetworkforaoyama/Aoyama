...
public class JobLauncher_JobGetOrderStatus {
	private static ApplicationContext context;

	public static void main(String[] args1) {
		context = new FileSystemXmlApplicationContext("src\\main\\resources\\META-INF\\jobs\\JobGetOrderStatus.xml");
		JobLauncher launcher = (JobLauncher) context.getBean("jobLauncher");
		Job job = (Job) context.getBean("JobGetOrderStatus");
