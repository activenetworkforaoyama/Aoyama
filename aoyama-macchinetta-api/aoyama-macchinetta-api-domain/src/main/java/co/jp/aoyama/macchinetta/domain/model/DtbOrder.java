...
public class DtbOrder implements Serializable {
    ...
    public void setScheduleDataTransmitStatus(String scheduleDataTransmitStatus) {
        this.scheduleDataTransmitStatus = scheduleDataTransmitStatus == null ? null : scheduleDataTransmitStatus.trim();
    }
    ...
    public void setShippingTransmitStatus(String shippingTransmitStatus) {
        this.shippingTransmitStatus = shippingTransmitStatus == null ? null : shippingTransmitStatus.trim();
    }
